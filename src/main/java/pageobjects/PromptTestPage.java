...
public class PromptTestPage extends Form {
    private final IButton soialBrandsBtn = getElementFactory().getButton(By.xpath("//span[text()='Social Brands Setup']"), "Social Brand Setup Button");
